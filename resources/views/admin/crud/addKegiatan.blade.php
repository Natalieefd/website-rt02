...
@section('content')
    <div class="relative flex items-center h-screen bg-primary">
        ...
        <h1 class="absolute right-32 uppercase text-8xl font-bold text-grey">add<br>data<br>kegiatan</h1>
        <div class="absolute font-poppins top-0 p-8 shadow-md w-fit h-full px-24 bg-primary justify-center">
            <form action="{{ route('admin.storeKegiatan') }}" method="post" class="pt-36" enctype="multipart/form-data">
                @csrf
                @if (session('error'))
                    <div class="mb-6">
                ...
                <div class="relative mb-5">
                    ...
                    <input type="text" name="namaKegiatan" placeholder="Nama Kegiatan"
