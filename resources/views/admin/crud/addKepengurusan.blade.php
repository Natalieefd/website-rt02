...
@section('content')
    <div class="relative flex items-center h-screen bg-primary">
        ...
        <h1 class="absolute right-32 uppercase text-8xl font-bold text-grey">add<br>data<br>anggota<br>kepengurusan</h1>
        <div class="absolute font-poppins top-0 p-8 shadow-md w-fit h-full px-24 bg-primary justify-center">
            <form action="{{ route('admin.storeKepengurusan') }}" method="post" class="pt-36" enctype="multipart/form-data">
                @csrf
                @if (session('error'))
                    <div class="mb-6">
                ...
                <div class="relative mb-5">
                    ...
                    <input type="text" name="namaAnggota" placeholder="Nama Anggota"
                ...
                <div class="relative mb-5">
                    ...
                    <input type="text" name="jabatanAnggota" placeholder="Jabatan Anggota"
                        class="w-full pl-4 pr-4 py-2 mt-2 bg-grey rounded-sm ring-1 ring-quaternary focus:outline-none focus:ring-pribg-primary">
                ...
                <div class="flex flex-col mb-7">
                    ...
                    <input type="file" name="fotoAnggota"
