...
@section('content')
    <div class="relative flex items-center h-screen bg-primary">
        ...
        <h1 class="absolute right-32 uppercase text-8xl font-bold text-grey">add<br>data<br>user</h1>
        <div class="absolute font-poppins top-0 p-8 shadow-md w-fit h-full px-24 bg-primary justify-center">
            <form action="{{ route('admin.storeUser') }}" method="post" class="pt-36" enctype="multipart/form-data">
                @csrf
                @if (session('error'))
                    <div class="mb-6">
                ...
                <div class="relative mb-5">
                    <label for="" class="capitalize font-medium text-quaternary px-2">username</label>
                ...
                <div class="relative mb-5">
                    <label for="" class="capitalize font-medium text-quaternary px-2">password</label>
                ...
                <a href="{{ route('admin.user') }}" class="w-full h-auto p-2 text-primary font-medium rounded-md flex justify-center items-center bg-quaternary hover:bg-teritary">
                    Cancel
                </a>
            </form>
        </div>
